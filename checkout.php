    ...
    <div id="checkoutLeft" class="CheckoutFrame" style="margin-left: 5%">
        <div id="checkoutInfo">
            ...
            <form method="post">
                ...
                <input type="email" class="checkoutInput" name="emailadres" value="<?php if($loggedIn){ echo $currentUser['email']; }?>" id="emailadres" placeholder="E-mailadres*" required>
                <input type="text" class="checkoutInput" name="adres" value="<?php if($loggedIn){ echo $currentUser['adres']; }?>" id="adres" placeholder="Adres*" required>
                <select style="width: 60%; height: 50px; padding-left: 5px; padding-right: 5px;" class="checkoutInput" id="land" name="land" required>
                    <?php if($loggedIn){
                       echo '<option value="' . $currentUser['land'] . '" selected>' . $currentUser['land'] . '</option>';
                    } else { 
                ...
                <input style="width: 39.3%" type="text" class="checkoutInput" name="postcode" value="<?php if($loggedIn){ echo $currentUser['postcode']; }?>" id="postcode" placeholder="Postcode*" required>
                <input type="text" class="checkoutInput" name="woonplaats" value="<?php if($loggedIn){ echo $currentUser['woonplaats']; }?>" id="woonplaats" placeholder="Woonplaats*" required>
                <input type="text" class="checkoutInput" name="telefoon" value="<?php if($loggedIn){ echo $currentUser['telefoon']; }?>" id="telefoon" placeholder="Telefoonnummer (optioneel)">
