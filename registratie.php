...
<!-- verwijderen van content div -->
    <script src="Public/JS/registratie-pagina.js"></script>

<!-- registratie pagina content -->
    ...
    <div class="register-container">
        ...
        <form action="registratie-handler.php" method="post" name="register-form">
            ...
            <div class="inputwithlabel">
                ...
                <input placeholder="wachtwoord" type="password" name="password" id="password-input">
            </div>
            ...
            <div class="inputwithlabel">
                <label for="voornaam-input">Voornaam</label>
                <input placeholder="voornaam" type="text" name="voornaam" id="voornaam-input">
            </div>

            <div class="inputwithlabel">
                <label for="tussenvoegsel-input">Tussenvoegsel</label>
                <input placeholder="tussenvoegsel" type="text" name="tussenvoegsel" id="tussenvoegsel-input">
            </div>

            <div class="inputwithlabel">
                <label for="achternaam-input">Achternaam</label>
                <input placeholder="achternaam" type="text" name="achternaam" id="achternaam-input">
            </div>

            <div class="inputwithlabel">
                <label for="adres-input">Adres</label>
                <input placeholder="straat en huisnummer" type="text" name="adres" id="adres-input">
            </div>
            ...
            <div class="inputwithlabel">
                ...
                <input placeholder="+31 6 01234567" type="text" name="phone" id="phone-input">
            </div>
